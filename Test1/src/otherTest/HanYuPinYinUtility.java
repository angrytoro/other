...
public class HanYuPinYinUtility {
	...
	public static void main(String[] args) {
		//将字符串转换成拼音数组
		String test1[]=stringToPinyin("曹顺写爪哇");
		String test1st="";
		for(int i=0;i<test1.length;i++){
			test1st+=test1[i];
		}
		System.out.println(test1st);
		//P.S(test1st);
		
		//将字符串转换成拼音数组,以逗号分隔
		String test2[]=stringToPinyin("曹顺写爪哇",",");
		String test2st="";
		...
		//将汉字转换成拼音
		//P.S("将汉字转换成拼音  曹顺写爪哇 ---->>>: "+hanziToPinyin("曹顺写爪哇!"," "));
		System.out.println("将汉字转换成拼音  曹顺写爪哇 ---->>>: "+hanziToPinyin("曹顺写爪哇!"," "));
	}
}
